...
func (m *CreateOrderBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOrderBadRequestBody) validateOrderRejectTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderBadRequestBody) validateRelatedTransactionIds(formats strfmt.Registry) error {
...
func (m *CreateOrderBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOrderBadRequestBody) UnmarshalBinary(b []byte) error {
