...
func (m *CreateOrderForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOrderForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOrderForbiddenBody) UnmarshalBinary(b []byte) error {
