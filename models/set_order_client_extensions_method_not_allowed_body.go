...
func (m *SetOrderClientExtensionsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetOrderClientExtensionsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetOrderClientExtensionsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
