...
func (m *ClosePositionUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClosePositionUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ClosePositionUnauthorizedBody) UnmarshalBinary(b []byte) error {
