...
func (m *ListTradesMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTradesMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTradesMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
