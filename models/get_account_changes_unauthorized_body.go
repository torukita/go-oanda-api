...
func (m *GetAccountChangesUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountChangesUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountChangesUnauthorizedBody) UnmarshalBinary(b []byte) error {
