...
func (m *ListOpenPositionsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOpenPositionsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOpenPositionsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
