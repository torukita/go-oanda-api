...
func (m *ListAccountsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAccountsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListAccountsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
