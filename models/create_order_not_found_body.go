...
func (m *CreateOrderNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOrderNotFoundBody) validateOrderRejectTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderNotFoundBody) validateRelatedTransactionIds(formats strfmt.Registry) error {
...
func (m *CreateOrderNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOrderNotFoundBody) UnmarshalBinary(b []byte) error {
