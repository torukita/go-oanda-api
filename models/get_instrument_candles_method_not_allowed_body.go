...
func (m *GetInstrumentCandlesMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentCandlesMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentCandlesMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
