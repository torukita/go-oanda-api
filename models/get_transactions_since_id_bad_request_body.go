...
func (m *GetTransactionsSinceIDBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionsSinceIDBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionsSinceIDBadRequestBody) UnmarshalBinary(b []byte) error {
