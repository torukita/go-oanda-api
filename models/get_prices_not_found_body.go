...
func (m *GetPricesNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPricesNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPricesNotFoundBody) UnmarshalBinary(b []byte) error {
