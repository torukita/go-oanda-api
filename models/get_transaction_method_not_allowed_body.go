...
func (m *GetTransactionMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
