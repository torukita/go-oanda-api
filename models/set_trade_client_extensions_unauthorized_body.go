...
func (m *SetTradeClientExtensionsUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetTradeClientExtensionsUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetTradeClientExtensionsUnauthorizedBody) UnmarshalBinary(b []byte) error {
