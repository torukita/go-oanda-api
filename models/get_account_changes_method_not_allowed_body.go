...
func (m *GetAccountChangesMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountChangesMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountChangesMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
