...
func (m *ConfigureAccountNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigureAccountNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConfigureAccountNotFoundBody) UnmarshalBinary(b []byte) error {
