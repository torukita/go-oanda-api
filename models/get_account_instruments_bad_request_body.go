...
func (m *GetAccountInstrumentsBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountInstrumentsBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountInstrumentsBadRequestBody) UnmarshalBinary(b []byte) error {
