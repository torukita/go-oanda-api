...
func (m *StreamPricingBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StreamPricingBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StreamPricingBadRequestBody) UnmarshalBinary(b []byte) error {
