...
func (m *ListOpenPositionsUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOpenPositionsUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOpenPositionsUnauthorizedBody) UnmarshalBinary(b []byte) error {
