...
func (m *GetTradeMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTradeMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTradeMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
