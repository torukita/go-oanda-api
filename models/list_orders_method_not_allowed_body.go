...
func (m *ListOrdersMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOrdersMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOrdersMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
