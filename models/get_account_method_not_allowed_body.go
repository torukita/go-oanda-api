...
func (m *GetAccountMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
