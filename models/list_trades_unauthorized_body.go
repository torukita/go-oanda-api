...
func (m *ListTradesUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTradesUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTradesUnauthorizedBody) UnmarshalBinary(b []byte) error {
