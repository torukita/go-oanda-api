...
func (m *GetInstrumentCandlesNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentCandlesNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentCandlesNotFoundBody) UnmarshalBinary(b []byte) error {
