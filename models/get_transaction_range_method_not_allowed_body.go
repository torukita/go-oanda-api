...
func (m *GetTransactionRangeMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionRangeMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionRangeMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
