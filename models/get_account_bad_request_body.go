...
func (m *GetAccountBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountBadRequestBody) UnmarshalBinary(b []byte) error {
