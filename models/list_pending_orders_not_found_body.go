...
func (m *ListPendingOrdersNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListPendingOrdersNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListPendingOrdersNotFoundBody) UnmarshalBinary(b []byte) error {
