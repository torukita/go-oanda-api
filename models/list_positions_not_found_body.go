...
func (m *ListPositionsNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListPositionsNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListPositionsNotFoundBody) UnmarshalBinary(b []byte) error {
