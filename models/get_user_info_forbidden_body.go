...
func (m *GetUserInfoForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUserInfoForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUserInfoForbiddenBody) UnmarshalBinary(b []byte) error {
