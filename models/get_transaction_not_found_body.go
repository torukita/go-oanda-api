...
func (m *GetTransactionNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionNotFoundBody) UnmarshalBinary(b []byte) error {
