...
func (m *GetInstrumentsInstrumentPositionBookNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentPositionBookNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentPositionBookNotFoundBody) UnmarshalBinary(b []byte) error {
