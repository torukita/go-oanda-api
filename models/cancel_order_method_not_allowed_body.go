...
func (m *CancelOrderMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CancelOrderMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CancelOrderMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
