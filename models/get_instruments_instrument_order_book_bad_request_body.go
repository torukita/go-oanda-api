...
func (m *GetInstrumentsInstrumentOrderBookBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentOrderBookBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentOrderBookBadRequestBody) UnmarshalBinary(b []byte) error {
