...
func (m *GetTransactionRangeBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionRangeBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionRangeBadRequestBody) UnmarshalBinary(b []byte) error {
