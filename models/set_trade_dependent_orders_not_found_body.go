...
func (m *SetTradeDependentOrdersNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetTradeDependentOrdersNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetTradeDependentOrdersNotFoundBody) UnmarshalBinary(b []byte) error {
