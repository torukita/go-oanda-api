...
func (m *GetInstrumentCandlesBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentCandlesBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentCandlesBadRequestBody) UnmarshalBinary(b []byte) error {
