...
func (m *GetTradeNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTradeNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTradeNotFoundBody) UnmarshalBinary(b []byte) error {
