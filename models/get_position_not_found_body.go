...
func (m *GetPositionNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPositionNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPositionNotFoundBody) UnmarshalBinary(b []byte) error {
