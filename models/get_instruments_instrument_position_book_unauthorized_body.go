...
func (m *GetInstrumentsInstrumentPositionBookUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentPositionBookUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentPositionBookUnauthorizedBody) UnmarshalBinary(b []byte) error {
