...
func (m *ListPositionsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListPositionsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListPositionsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
