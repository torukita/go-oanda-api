...
func (m *GetInstrumentsInstrumentOrderBookMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentOrderBookMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentOrderBookMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
