...
func (m *StreamTransactionsBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StreamTransactionsBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StreamTransactionsBadRequestBody) UnmarshalBinary(b []byte) error {
