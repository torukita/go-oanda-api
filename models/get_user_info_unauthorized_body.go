...
func (m *GetUserInfoUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUserInfoUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetUserInfoUnauthorizedBody) UnmarshalBinary(b []byte) error {
