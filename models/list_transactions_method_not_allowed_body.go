...
func (m *ListTransactionsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTransactionsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTransactionsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
