...
func (m *StreamTransactionsUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StreamTransactionsUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StreamTransactionsUnauthorizedBody) UnmarshalBinary(b []byte) error {
