...
func (m *CloseTradeUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloseTradeUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CloseTradeUnauthorizedBody) UnmarshalBinary(b []byte) error {
