...
func (m *CancelOrderUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CancelOrderUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CancelOrderUnauthorizedBody) UnmarshalBinary(b []byte) error {
