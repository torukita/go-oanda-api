...
func (m *GetTransactionRangeUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionRangeUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionRangeUnauthorizedBody) UnmarshalBinary(b []byte) error {
