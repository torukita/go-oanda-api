...
func (m *GetPricesMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPricesMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPricesMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
