...
func (m *GetAccountChangesNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountChangesNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountChangesNotFoundBody) UnmarshalBinary(b []byte) error {
