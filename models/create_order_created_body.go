...
func (m *CreateOrderCreatedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOrderCreatedBody) validateOrderCancelTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) validateOrderCreateTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) validateOrderFillTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) validateOrderReissueRejectTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) validateOrderReissueTransaction(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) validateRelatedTransactionIds(formats strfmt.Registry) error {
...
func (m *CreateOrderCreatedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOrderCreatedBody) UnmarshalBinary(b []byte) error {
