...
func (m *SetTradeDependentOrdersUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetTradeDependentOrdersUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetTradeDependentOrdersUnauthorizedBody) UnmarshalBinary(b []byte) error {
