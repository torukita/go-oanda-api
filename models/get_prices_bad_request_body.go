...
func (m *GetPricesBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPricesBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPricesBadRequestBody) UnmarshalBinary(b []byte) error {
