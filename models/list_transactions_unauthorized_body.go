...
func (m *ListTransactionsUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTransactionsUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTransactionsUnauthorizedBody) UnmarshalBinary(b []byte) error {
