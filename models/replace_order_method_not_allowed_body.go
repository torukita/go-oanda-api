...
func (m *ReplaceOrderMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReplaceOrderMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReplaceOrderMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
