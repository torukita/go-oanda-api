...
func (m *GetInstrumentsInstrumentPositionBookBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentPositionBookBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentPositionBookBadRequestBody) UnmarshalBinary(b []byte) error {
