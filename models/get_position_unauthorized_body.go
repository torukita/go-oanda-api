...
func (m *GetPositionUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPositionUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPositionUnauthorizedBody) UnmarshalBinary(b []byte) error {
