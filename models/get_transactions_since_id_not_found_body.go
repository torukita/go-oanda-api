...
func (m *GetTransactionsSinceIDNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionsSinceIDNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionsSinceIDNotFoundBody) UnmarshalBinary(b []byte) error {
