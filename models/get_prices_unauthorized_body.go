...
func (m *GetPricesUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPricesUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPricesUnauthorizedBody) UnmarshalBinary(b []byte) error {
