...
func (m *GetInstrumentsInstrumentOrderBookUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentOrderBookUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentOrderBookUnauthorizedBody) UnmarshalBinary(b []byte) error {
