...
func (m *ListOrdersBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOrdersBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOrdersBadRequestBody) UnmarshalBinary(b []byte) error {
