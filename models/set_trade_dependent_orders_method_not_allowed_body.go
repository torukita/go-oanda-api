...
func (m *SetTradeDependentOrdersMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetTradeDependentOrdersMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetTradeDependentOrdersMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
