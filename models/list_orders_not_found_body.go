...
func (m *ListOrdersNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOrdersNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOrdersNotFoundBody) UnmarshalBinary(b []byte) error {
