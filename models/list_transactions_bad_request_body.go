...
func (m *ListTransactionsBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTransactionsBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTransactionsBadRequestBody) UnmarshalBinary(b []byte) error {
