...
func (m *GetInstrumentsInstrumentPositionBookMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentPositionBookMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentPositionBookMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
