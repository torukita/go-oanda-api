...
func (m *GetTransactionUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTransactionUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTransactionUnauthorizedBody) UnmarshalBinary(b []byte) error {
