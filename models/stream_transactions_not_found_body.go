...
func (m *StreamTransactionsNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StreamTransactionsNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StreamTransactionsNotFoundBody) UnmarshalBinary(b []byte) error {
