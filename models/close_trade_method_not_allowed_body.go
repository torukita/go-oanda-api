...
func (m *CloseTradeMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloseTradeMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CloseTradeMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
