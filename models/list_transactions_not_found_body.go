...
func (m *ListTransactionsNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTransactionsNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTransactionsNotFoundBody) UnmarshalBinary(b []byte) error {
