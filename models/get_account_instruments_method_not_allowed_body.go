...
func (m *GetAccountInstrumentsMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountInstrumentsMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountInstrumentsMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
