...
func (m *ListTradesNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTradesNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTradesNotFoundBody) UnmarshalBinary(b []byte) error {
