...
func (m *ConfigureAccountUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigureAccountUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConfigureAccountUnauthorizedBody) UnmarshalBinary(b []byte) error {
