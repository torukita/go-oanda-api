...
func (m *CreateOrderMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOrderMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOrderMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
