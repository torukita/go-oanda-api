...
func (m *GetPositionMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPositionMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPositionMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
