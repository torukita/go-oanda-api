...
func (m *ListTransactionsForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTransactionsForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTransactionsForbiddenBody) UnmarshalBinary(b []byte) error {
