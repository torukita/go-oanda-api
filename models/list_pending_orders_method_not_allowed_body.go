...
func (m *ListPendingOrdersMethodNotAllowedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListPendingOrdersMethodNotAllowedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListPendingOrdersMethodNotAllowedBody) UnmarshalBinary(b []byte) error {
