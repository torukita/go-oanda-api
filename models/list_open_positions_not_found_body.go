...
func (m *ListOpenPositionsNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListOpenPositionsNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListOpenPositionsNotFoundBody) UnmarshalBinary(b []byte) error {
