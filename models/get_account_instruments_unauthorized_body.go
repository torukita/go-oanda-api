...
func (m *GetAccountInstrumentsUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAccountInstrumentsUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetAccountInstrumentsUnauthorizedBody) UnmarshalBinary(b []byte) error {
