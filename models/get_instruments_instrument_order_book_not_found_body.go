...
func (m *GetInstrumentsInstrumentOrderBookNotFoundBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInstrumentsInstrumentOrderBookNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetInstrumentsInstrumentOrderBookNotFoundBody) UnmarshalBinary(b []byte) error {
