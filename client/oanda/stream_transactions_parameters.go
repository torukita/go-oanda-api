...
// NewStreamTransactionsParams creates a new StreamTransactionsParams object
// with the default values initialized.
func NewStreamTransactionsParams() *StreamTransactionsParams {
	var ()
	return &StreamTransactionsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewStreamTransactionsParamsWithTimeout creates a new StreamTransactionsParams object
...
// NewStreamTransactionsParamsWithContext creates a new StreamTransactionsParams object
...
// NewStreamTransactionsParamsWithHTTPClient creates a new StreamTransactionsParams object
...
/*StreamTransactionsParams contains all the parameters to send to the API endpoint
for the stream transactions operation typically these are written to a http.Request
*/
...
func (o *StreamTransactionsParams) WithTimeout(timeout time.Duration) *StreamTransactionsParams {
...
func (o *StreamTransactionsParams) WithContext(ctx context.Context) *StreamTransactionsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *StreamTransactionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
